...
from datasets.dataset import Val_Dataset, Dataset, mag_pha_stft, mag_pha_istft, mag_phase_stft, get_dataset_filelist
from models.generator import LORT, pesq_score, phase_losses
...
def train(rank, a, h):
    ...
    train_loader = DataLoader(trainset, num_workers=h.num_workers, shuffle=False,
                              ...
                              drop_last=True)
    if rank == 0:
        validset = Val_Dataset(validation_indexes, a.input_clean_wavs_dir2, a.input_noisy_wavs_dir2,
                           h.segment_size, h.n_fft, h.hop_size, h.win_size, h.sampling_rate, h.compress_factor,
    ...
    for epoch in range(max(0, last_epoch), a.training_epochs):
        ...
        for i, batch in enumerate(train_loader):
            ...
            # Consistancy Loss
            _, _, rec_com = mag_phase_stft(audio_g, h.n_fft, h.hop_size, h.win_size, h.compress_factor, addeps=True)
            ...
            if rank == 0:
                ...
                if steps % a.stdout_interval == 0:
                    ...
                    print('Steps : {:d}, Gen Loss: {:4.3f}, Disc Loss: {:4.3f}, Metric loss: {:4.3f}, Magnitude Loss : {:4.3f}, Phase Loss : {:4.3f}, Complex Loss : {:4.3f}, Consistancy Loss : {:4.3f}, s/b : {:4.3f}'.
                           format(steps, loss_gen_all, loss_disc_all, metric_error, mag_error, pha_error, com_error, con_error, time.time() - start_b))
